...
VENV_WEB=${VENV_WEB:-/opt/omero/web/venv3}
python3 -mvenv $VENV_WEB

$VENV_WEB/bin/pip install https://github.com/ome/zeroc-ice-ubuntu1804/releases/download/0.3.0/zeroc_ice-3.6.5-cp36-cp36m-linux_x86_64.whl
